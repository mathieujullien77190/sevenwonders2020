...
Template.board_template.events({
    ...
    'click .addPlayer'() {
        const allPlayers = [
            { id: 1, pseudo: 'Matou', wonder: getWonder(14) },
            { id: 2, pseudo: 'Gregou', wonder: getWonder(15) },
            { id: 3, pseudo: 'flouflou', wonder: getWonder(16) },
            { id: 4, pseudo: 'Manou', wonder: getWonder(2) },
